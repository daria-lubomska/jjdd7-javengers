...
public class FilteringService {
    ...
    public List<Recipe> getFavouritesFiltersQuery(List<Long> ids, List<String> names, List<String> types,
        Long userId) {
        List<Category> categories = categoryDaoBean.getCategoriesById(ids);
        List<Ingredient> ingredients = ingredientDaoBean.getIngredientsByName(names);
        List<String> drinkTypes = recipeDaoBean.getRecipeTypeByName(types);
    ...
    public List<Recipe> getFavouritesFiltersQueryByCategoryAndType(List<Long> ids, List<String> types,
        Long userId) {
        List<Category> categories = categoryDaoBean.getCategoriesById(ids);
        List<String> drinkTypes = recipeDaoBean.getRecipeTypeByName(types);
