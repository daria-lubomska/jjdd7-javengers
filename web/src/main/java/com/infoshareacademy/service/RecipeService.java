...
public class RecipeService {
    ...
    List<Recipe> findRecipeByCategoryIdAndIngredientAndType(List<Category> categories,
        ...
        return recipeDaoBean.findRecipeByCategoryIdAndIngredientAndType(categories, ingredients,
            namesLength, drinkTypes);
    }
    ...
    List<Recipe> findFavouriteByCategoryIdAndIngredientAndType(List<Category> categories,
        ...
        return recipeDaoBean.findFavouriteByCategoryIdAndIngredientAndType(categories,
            ingredients, namesLength, drinkTypes, userId);
    }
