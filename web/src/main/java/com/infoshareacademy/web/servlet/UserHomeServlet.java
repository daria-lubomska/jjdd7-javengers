...
public class UserHomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        checkedCategoriesAndIngredientsAndTypes = startingPageService.filterContentList
            (checkedOptionList, checkedIngredientsList, parsedToLongCategoriesList, checkedTypesList, userId);
        List<Recipe> recipeListPerPage = startingPageService.getRecipesPerPage(pageNo,
            checkedCategoriesAndIngredientsAndTypes);
        List<Long> favouriteRecipeIdsFromUser = recipeService.getFavouritesListIdsForUser(userId);
        Integer lastPageNumber = startingPageService.getLastNumberPage
            (checkedCategoriesAndIngredientsAndTypes);
